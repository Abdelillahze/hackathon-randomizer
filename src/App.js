...
function App() {
  ...
  return (
    <div className="flex flex-col w-full h-dvh overflow-x-hidden">
      <header className="flex items-center px-4 py-4 w-full h-14 text-grey-200 bg-grey-900">
        Randomizer
      </header>
      <section className="flex flex-col md:flex-row justify-between w-full h-full py-4">
        <div className="w-full h-3/5 lg:w-3/4 md:h-full grid place-items-center mb-4">
